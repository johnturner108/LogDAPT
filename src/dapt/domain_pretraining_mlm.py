...
if args.model_output == None:
    if args.dataset == 'hdfs':
        args.model_output = '../../models/hdfs/mlm'
    elif args.dataset == 'bgl':
        args.model_output = '../../models/bgl/mlm'
    elif args.dataset == 'tbird':
        args.model_output = '../../models/tbird/mlm'

from transformers import BertTokenizer, BertForMaskedLM, AdamW, get_linear_schedule_with_warmup

pretrained_model_str = 'bert-base-uncased'

bert_model = BertForMaskedLM.from_pretrained(pretrained_model_str)
...
trainer.save_model(os.path.join(args.model_output, 'LogDAPT_MLM_' + args.dataset))
